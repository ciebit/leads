...
CREATE TABLE `leads_content` (
    ...
    `external_share_cover_id` INT(5) UNSIGNED DEFAULT NULL,
...
INSERT INTO `leads_records` (
    `id`, `content_id`, `name`, `email`, `phone`, `profile_id`, `date_time`
) VALUES (
    1, 5, 'Leonardo da Vince', 'leo@art.com', '0012341234', 1, '2020-06-01 16:28:00'
),(
    2, 4, 'Salvador Dalí', 'salvador@art.com', '0012345678', 2, '2020-06-01 17:28:00'
),(
    3, 3, 'Michelangelo', 'michelangelo@art.com', '0012340123', 3, '2020-06-01 18:28:00'
),(
    4, 3, 'Rafael Sanzio', 'rafael@art.com', '0012343210', 4, '2020-06-02 16:04:00'
);
